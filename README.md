...
[![GoDoc](https://godoc.org/github.com/alaaelgndy/go-readability?status.png)](https://godoc.org/github.com/alaaelgndy/go-readability)
[![Travis CI](https://travis-ci.org/alaaelgndy/go-readability.svg?branch=master)](https://travis-ci.org/alaaelgndy/go-readability)
[![Go Report Card](https://goreportcard.com/badge/github.com/alaaelgndy/go-readability)](https://goreportcard.com/report/github.com/alaaelgndy/go-readability)
...
```
go get -u -v github.com/alaaelgndy/go-readability
```
...
```
go get -u -v github.com/alaaelgndy/go-readability/cmd/...
```
